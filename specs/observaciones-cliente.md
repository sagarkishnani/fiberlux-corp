...
| 6 | **Rubros: actualizar íconos** según referencia | Rubros (Nosotros) | Diseño/contenido | **Hecho (best-effort)** | Minería → pico (LuPickaxe). Si quieren TODO el set en outline, es un follow-up. |
