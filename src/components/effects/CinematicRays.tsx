...
/**
 * CinematicRays — atmósfera "cinematic" (god-rays + iconos flotantes + polvo),
 * recuperada del hero home pre-planeta (SPEC 97 histórico) y reusada en el hero
 * de soluciones (SPEC 98). WebGL autocontenido.
 *
