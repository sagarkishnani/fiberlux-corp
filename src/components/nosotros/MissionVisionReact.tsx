    ...
    >
      <div className="site-container">
        ...
        {/* ── Política del SGSI (ISO 27001) ──
            Vive dentro de esta misma sección (y no en una banda aparte) para que
            hile con Misión/Visión: mismo fondo rosa, separado sólo por una línea.
            Por eso va con la paleta clara —morado oscuro sobre rosa—, no con el
            morado del diseño original. */}
        {sgsi && (sgsiTitle || sgsiItems.length > 0) && (
          <div className="relative mt-14 md:mt-20 pt-12 md:pt-16">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, rgba(150,35,122,0) 0%, rgba(150,35,122,0.15) 15%, rgba(150,35,122,0.45) 50%, rgba(150,35,122,0.15) 85%, rgba(150,35,122,0) 100%)',
              }}
            />
              ...
              <div data-reveal="up">
                {sgsiBadge && (
                  <div className="flex items-center gap-4 mb-6">
                    <span className="w-11 h-11 rounded-xl bg-brand-purple/10 border border-brand-purple/25 flex items-center justify-center shrink-0">
                ...
                <ol className="flex flex-col gap-8 md:gap-10" data-reveal="up" data-reveal-stagger="0.08">
                  {sgsiItems.map((item, i) => (
                    <li key={i} className="flex gap-4 md:gap-6">
                      <span className="font-mono text-xs md:text-sm text-brand-purple pt-1 w-6 md:w-7 shrink-0">
                        {String(i + 1).padStart(2, '0')}
                      </span>
                      <p
                        className="text-brand-purple-darkest/75 text-sm md:text-base leading-relaxed"
