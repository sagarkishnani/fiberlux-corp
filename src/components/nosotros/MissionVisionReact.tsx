        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-40">
          ...
          <div className="flex flex-col" data-reveal="left" data-reveal-scrub data-reveal-only="desktop">
            ...
            <div data-reveal="left" data-reveal-scrub data-reveal-only="mobile">
              <h2
                className="text-[30px] leading-[36px] min-[380px]:text-[36px] min-[380px]:leading-[42px] md:text-[48px] md:leading-[56px] font-medium text-white mb-10"
            ...
            <div data-reveal="right" data-reveal-scrub data-reveal-only="mobile">
              ...
              {mission && (
                <div
                  className="border border-white/25 rounded-2xl p-6 mb-4"
              ...
              {vision && (
                <div
                  className="border border-white/25 rounded-2xl p-6"
          ...
          <div className="hidden lg:flex items-start" data-reveal="right" data-reveal-scrub>
            {image ? (
              ...
              <div className="w-full h-full min-h-[400px] rounded-2xl bg-white/10 flex items-center justify-center text-white/40 text-sm">
        ...
        {sgsi && (sgsiTitle || sgsiItems.length > 0) && (
          <div className="relative mt-14 md:mt-20 pt-12 md:pt-16">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.12) 15%, rgba(255,255,255,0.5) 50%, rgba(255,255,255,0.12) 85%, rgba(255,255,255,0) 100%)',
              }}
            />
              ...
              <div data-reveal="up">
                {sgsiBadge && (
                  <div className="flex items-center gap-4 mb-6">
                    <span className="w-11 h-11 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center shrink-0">
                    ...
                    <span
                      className="font-mono text-xs md:text-sm tracking-[0.2em] text-white"
                ...
                {sgsiTitle && (
                  <h3
                    className="text-[26px] leading-[32px] md:text-[36px] md:leading-[44px] font-medium text-white mb-6"
                ...
                {sgsiIntro && (
                  <div
                    className="text-white/70 text-sm md:text-base leading-relaxed [&_p]:mb-4 [&_p:last-child]:mb-0 [&_strong]:font-semibold [&_strong]:text-white"
                ...
                <ol className="flex flex-col gap-8 md:gap-10" data-reveal="up" data-reveal-stagger="0.08">
                  {sgsiItems.map((item, i) => (
                    <li key={i} className="flex gap-4 md:gap-6">
                      <span className="font-mono text-xs md:text-sm text-white/60 pt-1 w-6 md:w-7 shrink-0">
