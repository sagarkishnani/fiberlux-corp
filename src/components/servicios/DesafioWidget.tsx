  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="relative mt-2 flex items-center justify-center" style={{ height: size, width: size }}>
        ...
        <span
          aria-hidden="true"
          className="dw-node-core relative flex h-full w-full items-center justify-center rounded-2xl bg-[#96237A]/20 text-[#F5B4E6] border border-[#D64DB8]/55 shadow-[0_0_18px_rgba(214,77,184,0.25)] backdrop-blur-sm"
        >
          {icon}
        </span>
      </span>
  ...
  return (
    <div className="flex w-full max-w-[300px] flex-col items-center">
      <div className="relative h-[150px] w-full">
        ...
        <span className="absolute left-0 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-2xl bg-[#96237A]/20 text-[#F5B4E6] border border-[#D64DB8]/55 shadow-[0_0_18px_rgba(214,77,184,0.25)] backdrop-blur-sm">
          <FaServer size={16} />
        </span>
        <span className="absolute right-0 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-2xl bg-[#96237A]/20 text-[#F5B4E6] border border-[#D64DB8]/55 shadow-[0_0_18px_rgba(214,77,184,0.25)] backdrop-blur-sm">
          <FaCloud size={18} />
        </span>
    ...
    <div className="mb-24 flex w-full max-w-[260px] flex-col items-center sm:max-w-[300px] md:mb-32">
      <div className="relative h-[176px] w-full">
        ...
        <span className="absolute left-1/2 top-0 z-10 h-11 w-11 -translate-x-1/2 md:h-[52px] md:w-[52px]">
          ...
          <span className="dw-node-core relative flex h-full w-full items-center justify-center rounded-2xl bg-[#96237A]/20 text-[#F5B4E6] border border-[#D64DB8]/55 shadow-[0_0_18px_rgba(214,77,184,0.25)] backdrop-blur-sm">
        ...
        {sites.map((s, i) => (
          <span
            key={i}
            className="dw-site absolute bottom-0 z-10 flex h-9 w-9 items-center justify-center rounded-2xl bg-[#96237A]/20 text-[#F5B4E6] border border-[#D64DB8]/55 shadow-[0_0_18px_rgba(214,77,184,0.25)] backdrop-blur-sm md:h-10 md:w-10"
