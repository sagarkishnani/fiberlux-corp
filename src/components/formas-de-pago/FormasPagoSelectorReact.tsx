    ...
    <div className="grid md:grid-cols-[1fr_minmax(0,420px)] gap-6 md:gap-10 items-center py-10 border-t border-white/10">
      <div>
        ...
        <div className="flex gap-3 mt-4">
          ...
          />
          <div
            className="text-[18px] md:text-[20px] text-greyscale-light leading-relaxed"
  ...
  return (
    <div className="relative w-full sm:w-[240px]">
      <select
        ...
        className="w-full appearance-none rounded-lg bg-white/[0.04] border border-white/15 text-greyscale-white text-[17px] md:text-lg pl-4 pr-10 py-3 cursor-pointer hover:border-white/30 focus:outline-none focus:border-[#c65fac] transition-colors"
      >
        {options.map((label, i) => (
